...
class EMT_Tret_Abbr extends EMT_Tret
{
	...
	public $rules = array(
		...
		'nbsp_money_abbr' => array(
				...
				'pattern' 		=> '/(\d)((\040|\&nbsp\;)?(тыс|млн|млрд)\.?(\040|\&nbsp\;)?)?(\040|\&nbsp\;)?(руб\.|долл\.|BYN|евро|€|&euro;|\$|у[\.]? ?е[\.]?)/ieu', 
...
class EMT_Tret_Nobr extends EMT_Tret
{
	...
	public $rules = array(
		...
		'phone_builder' => array(
				...
				'pattern' 		=> 
					array(
						'/([^\d\+]|^)([\+]?[0-9]{1,3})( |\&nbsp\;|\&thinsp\;)([0-9]{2,4}|\([0-9]{2,4}\))( |\&nbsp\;|\&thinsp\;)([0-9]{2,3})(-|\&minus\;)([0-9]{2})(-|\&minus\;)([0-9]{2})([^\d]|$)/e',
